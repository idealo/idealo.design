...
UPDATE blogposts SET previouspost = 3 and nextpost = 1 where id=2;
UPDATE blogposts SET previouspost = 4 and nextpost = 2 where id=3;
UPDATE blogposts SET previouspost = 5 and nextpost = 3 where id=4;
UPDATE blogposts SET previouspost = 6 and nextpost = 4 where id=5;
