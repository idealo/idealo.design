...
import {fetchDistinctCategories, fetchSinglePost, updateSinglePost} from '../data';
        ...
        return (
            <>
                ...
                <div className={s.InputFields}>
                    <input
                        className={this.state.error['title-empty'] ? s.empty : '' || this.state.error['title-value'] ? s.empty : '' || this.state.error['existing-title-value'] ? s.empty : ''}
                        onChange={this.handleChange} name="title" title="titleInput" value={this.state.title}
                        placeholder="Title"/>
                ...
                <div
                    className={this.state.error['editorState'] ? s.empty + ' ' + s["RichEditor-root"] : s["RichEditor-root"]}>
                    <BlockStyleControls
                ...
                <div className={s['newBlogPostButtons']}>
                    <button title='submitButton' className={s['SubmitButton']} onClick={this.handleSubmit}>Submit
                    </button>
                    <button title='cancelButton' className={s['CancelButton']}
                            onClick={this.handleCancellation}>Cancel
                    </button>
                </div>
                <Prompt
