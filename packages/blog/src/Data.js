...
const data = [
  {
    ...
    "author": {
               ...
               "github" : "https://github.com/",
                ...
                "email": "christiano.renaldo@email.com",
                }
  },
...
export function fetchSinglePost({ id }) {
  ...
  return data.filter(post => post.id === postId).pop()
}
